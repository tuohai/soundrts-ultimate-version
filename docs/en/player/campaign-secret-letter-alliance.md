...
Definitions: [rules.txt](../../../res/single/The Legend of Raynor/rules.txt). TTS: `ui/tts.txt`, `ui-zh/tts.txt` (7575–7718, 7720–7730, 7740–7745).
...
| AI modes | [unit-default-behavior.md](unit-default-behavior.md) |

| Index selectors | [map-unit-index-selectors.md](map-unit-index-selectors.md) |

| Official syntax | `doc_src/src/en/mapmaking.rst` |
