            ...
            for stat, value in self.allow_units_add.items():
                if hasattr(self, stat):
                    ...
                    if isinstance(current_value, (int, float)):
                        # 对于速度和伤害属性，需要特殊处理
                        if stat == 'speed' or stat in (
                                'mdg', 'rdg', 'mdf', 'rdf', 'mdg_vs', 'rdg_vs', 'mdf_vs', 'rdf_vs', 'mdg_delay',
                                'rdg_delay',
                                'mdg_cd', 'rdg_cd', 'mdg_cd_vs', 'rdg_cd_vs', 'mdg_ready', 'rdg_ready', 'mdg_ready_vs',
                                'rdg_ready_vs', 'mdg_range', 'rdg_range', 'mdg_range_vs', 'rdg_range_vs',
                                'mdg_minimal_range',
                                'rdg_minimal_range', 'mdg_minimal_range_vs', 'rdg_minimal_range_vs', 'mdg_splash',
                                'rdg_splash',
