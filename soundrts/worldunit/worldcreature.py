...
class Creature(CreatureAttributes, CreatureMovement, CreatureAttack, CreatureStatusUpdate,
    ...
    # Building volley from garrison (arrows, cannon, etc.); empty fires only if base_shots > 0
    garrison_shots = 0
    base_shots = 0
    max_garrison_shots = 0
    ...
    def __init__(self, player, place, x, y, o=90):
        ...
        self.mdg_pierce_decay = type(self).mdg_pierce_decay
        self.rdg_pierce_decay = type(self).rdg_pierce_decay
        self.mdg_bounce = type(self).mdg_bounce
        self.rdg_bounce = type(self).rdg_bounce
        self.mdg_bounce_range = type(self).mdg_bounce_range
        self.rdg_bounce_range = type(self).rdg_bounce_range
        self.mdg_bounce_decay = type(self).mdg_bounce_decay
        self.rdg_bounce_decay = type(self).rdg_bounce_decay
