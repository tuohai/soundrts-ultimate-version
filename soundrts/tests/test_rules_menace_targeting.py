...
def _stub_unit(cls, *, mdg=None, rdg=None, hp=None):
    ...
    u.mdg_hit_rate = getattr(cls, "mdg_hit_rate", 0)
    u.rdg_hit_rate = getattr(cls, "rdg_hit_rate", 0)
    u.mdg_dodge_rate = getattr(cls, "mdg_dodge_rate", 0)
    u.rdg_dodge_rate = getattr(cls, "rdg_dodge_rate", 0)
