...
class Rules(_Definitions):
    ...
    int_properties = {
        ...
        # Building volley: base_shots + firing garrison (not passenger shots). Weapon-agnostic.
        "garrison_shots",  # 1 = use garrison volley; empty fires only if base_shots > 0
        "base_shots",  # shots when empty (generic TC 0; Teutons 5). Arrow, cannon, or other rdg.
        "max_garrison_shots",  # extra shots from passenger_attack_types inside (0 → 10)
