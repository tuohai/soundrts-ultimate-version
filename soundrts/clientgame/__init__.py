...
GameInterface.cmd_say_square_info = game_navigation.cmd_say_square_info
GameInterface.cmd__exit_square_info_screen = game_navigation.cmd__exit_square_info_screen
GameInterface.cmd__square_info_prev = game_navigation.cmd__square_info_prev
GameInterface.cmd__square_info_next = game_navigation.cmd__square_info_next
GameInterface.cmd__square_info_sub_prev = game_navigation.cmd__square_info_sub_prev
GameInterface.cmd__square_info_sub_next = game_navigation.cmd__square_info_sub_next
...
GameInterface.cmd_history_stop_primary = game_audio.cmd_history_stop_primary
GameInterface.cmd_history_stop_secondary = game_audio.cmd_history_stop_secondary
