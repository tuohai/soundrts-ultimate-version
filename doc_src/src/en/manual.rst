...
| Screen           | Key              | Shows                                    |
+==================+==================+==========================================+
| Properties       | Alt+V            | All unit stats                           |
| Backpack         | Shift+V          | Every item in inventory                  |
| Equipment        | Ctrl+V           | Weapons and armor (built-in + inventory) |
+------------------+------------------+------------------------------------------+
...
not "neutral , NPC" (see ``docs/en/hunting-system.md``).
