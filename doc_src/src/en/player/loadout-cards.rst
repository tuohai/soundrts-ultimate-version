...
File format: `../mod/delayed-card-loadout.htm <../mod/delayed-card-loadout.htm>`_.
...
.. list-table::
   ...
   * - New player, no cards yet
     - Straight into the match — no card menu
   * - Random faction
     - May only hear faction selection, not cards
   * - Rank too low
     - Cards stay in armory but can’t be selected
