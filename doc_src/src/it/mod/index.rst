...
3. `Manuale di modding <modding.htm>`_ — riferimento completo delle parole chiave; penetrazione in linea ``rdg_pierce_line`` e rimbalzo ``rdg_bounce`` nel sistema di combattimento
